...
import { Globe, Github, Linkedin, ExternalLink, Play, Presentation, FileText, Palette, Edit, Award, Youtube, Instagram } from 'lucide-react';
  ...
  return (
    <li className="relative ml-10 py-4">
      ...
      <div className="flex flex-1 flex-col justify-start gap-1">
        ...
        {description && (
          <div className="prose pr-8 text-md dark:prose-invert" dangerouslySetInnerHTML={{ __html: description }} />
        )}
...
export default function CustomSectionTimelineStatic({ section }: { section: StaticSectionData }) {
  ...
  return (
    <section id={`custom-${sectionId}`} className="mb-14">
